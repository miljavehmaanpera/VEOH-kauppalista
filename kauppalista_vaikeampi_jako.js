...
const kayttaja_model = require('./models/kayttaja_model.js');
const tuote_model = require('./models/tuote_model.js');
const kauppalista_model = require('./models/kauppalista_model.js');

const getit = require('./getit/getit');
